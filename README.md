...
You can view all data sourced from the Intel Image Classification dataset on Kaggle, which can be found here: https://www.kaggle.com/datasets/puneet6060/intel-image-classification/data. 
